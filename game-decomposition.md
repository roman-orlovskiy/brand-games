...
### 5.3 Базовый деплой (6 часов)
- **Настройка сервера** (4 часа)
  - Установка Ubuntu/CentOS
  - Настройка Nginx + SSL
...
| **ДОПОЛНИТЕЛЬНО** | **16 часов** | Базовая безопасность, тестирование, деплой |
| ├─ Базовая безопасность | 2ч | Валидация, защита от XSS |
| ├─ Тестирование | 8ч | Функциональное, кроссбраузерное, фиксы |
| └─ Базовый деплой | 6ч | Сервер, резервы |

### 📊 **ОБЩЕЕ ВРЕМЯ: 166 ЧАСОВ**
