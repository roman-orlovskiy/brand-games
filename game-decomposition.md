...
- **Компонент ResultModal.vue** (4 часа)
  ...
  - В начале данные пользователя и только потом промокод
...
### 2.2 API для игры (10 часов)

#### 2.2.1 Игровые эндпоинты (4 часа)
...
- **PromoCodeService.js** (4 часа)
  - Сохранение промокодов, в том числе уникальных
  - Пуш на почту клиенту, если уникальные промокоды заканичваются
...
- **PromoCodeGenerator.vue** (2 часа)
  - Сохранение промокодов (уникальных или нет)
...
| **БЭКЕНД** | **37 часов** | Node.js + MySQL |
| ├─ Сервер | 6ч | Express, БД, JWT аутентификация |
| ├─ API игры | 10ч | Игровые эндпоинты |
